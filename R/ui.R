...
### Page title 
titlePanel("Rai Lab Data Analysis"),  
navbarPage( 
  NULL,  
 # navbarMenu("Gene Accessibility",### Tab1.a1: cellInfo vs geneExpr on dimRed 
  tabPanel( 
    ...
    fluidRow( 
      ...
      column( 
        3, actionButton("sc1a1tog0", "Toggle graphics controls"), 
        conditionalPanel( 
      ...
      column( 
        ...
        fluidRow( 
          column( 
            12, selectInput("sc1a1drX2", "X-axis:", choices = sc1conf[dimred == TRUE]$UI, 
                            selected = sc1def$dimred[1]), 
  ...
  tabPanel( 
    ...
    fluidRow( 
      ...
      column( 
        3, actionButton("sc1a2tog0", "Toggle graphics controls"), 
        conditionalPanel( 
      ...
      column( 
        ...
        fluidRow( 
          column( 
            12, selectInput("sc1a2drX2", "X-axis:", choices = sc1conf[dimred == TRUE]$UI, 
                            selected = sc1def$dimred[3]), 
  ...
  tabPanel( 
    ...
    fluidRow( 
      ...
      column( 
        3, actionButton("sc1a3tog0", "Toggle graphics controls"), 
        conditionalPanel( 
      ...
      column( 
        ...
        fluidRow( 
          column( 
            12, selectInput("sc1a3drX2", "X-axis:", choices = sc1conf[dimred == TRUE]$UI, 
                            selected = sc1def$dimred[5]), 
    ...
    fluidRow( 
      column( 
        6, style="border-right: 2px solid black", h4("Gene accessibility 1"), 
        fluidRow( 
          column( 
 ...
 tabPanel( 
   ...
   fluidRow( 
     column( 
       3, style="border-right: 2px solid black", h4("Gene Accessibility"), 
...
tabPanel(
  ...
  fluidRow(
    ...
    fluidRow(column(6, plotOutput("sc1de1oup"))    ),  # End of column (6 space),
    fluidRow( column(6,
  ...
  tabPanel( 
    ...
    h4("Gene accessibility bubbleplot / heatmap"), 
...
tabPanel( 
  ...
  fluidRow( 
    ...
    column( 
      3, actionButton("sc2a3tog0", "Toggle graphics controls"), 
      conditionalPanel( 
    ...
    column(
      ...
      fluidRow(
        column(
          12, selectInput("sc2a3drX2", "X-axis:", choices = sc1conf[dimred == TRUE]$UI,
                          selected = sc1def$dimred[5]),
  ...
  fluidRow( 
    column( 
      6, style="border-right: 2px solid black", h4("Motif enrichment 1"), 
      fluidRow( 
        column( 
          6, selectInput("sc2a3inp1", "Motif name:", choices=NULL) %>%  
            helper(type = "inline", size = "m", fade = TRUE, 
    ...
    column( 
      6, h4("Motif enrichment 2"), 
      fluidRow( 
        column( 
          6, selectInput("sc2a3inp2", "Motif name:", choices=NULL) %>%  
            helper(type = "inline", size = "m", fade = TRUE, 
                   title = "Motif enrichment to colour cells by", 
                   content = c("Select motif to colour cells by motif enrichment", 
                               paste0("- Motif enrichment are coloured in a ", 
...
tabPanel( 
  HTML("Bubbleplot / Heatmap"), 
  h4("Motif enrichment bubbleplot / heatmap"), 
 ...
 # "The normalised enrichment are averaged, log-transformed and then plotted.", 
  ...
  fluidRow( 
    column( 
      3, style="border-right: 2px solid black", 
      textAreaInput("sc2d1inp", HTML("List of motif names <br /> 
                                          (Max 50 motifs, separated <br /> 
                                           by , or ; or newline):"), 
                    height = "200px", 
                    value = paste0(sc2def$genes, collapse = ", ")) %>% 
        helper(type = "inline", size = "m", fade = TRUE, 
               title = "List of motifs to plot on bubbleplot / heatmap", 
      ...
      radioButtons("sc2d1plt", "Plot type:", 
                   choices = c("Bubbleplot", "Heatmap"), 
                   selected = "Heatmap", inline = TRUE), 
     checkboxInput("sc2d1scl", "Scale motif enrichment", value = TRUE),
      checkboxInput("sc2d1row", "Cluster rows (motifs)", value = TRUE), 
      checkboxInput("sc2d1col", "Cluster columns (Clusters,samples,..)", value = FALSE), 
      br(), 
...
tabPanel(
  ...
  fluidRow(
    ...
    fluidRow(column(6, plotOutput("sc2logooup"))    ),  # End of column (6 space),
    fluidRow( column(6,
