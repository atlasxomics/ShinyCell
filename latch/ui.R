        ...
        fluidPage(
          sidebarLayout(
            sidebarPanel( width = 6,
                          ...
                          selectInput("sc1a1drX", "X-axis:", choices = sc1conf[dimred == TRUE]$UI, 
        ...
        fluidPage(
          sidebarLayout(
            sidebarPanel( width = 6,
                          ...
                          selectInput("sc1a1drX2", "X-axis:", choices = sc1conf[dimred == TRUE]$UI, 
    ...
    fluidRow( 
      column( 
        ...
        fluidPage(
          sidebarLayout(
            sidebarPanel(width = 6,
                         selectInput("sc1a2drX", "X-axis:", choices = sc1conf[dimred == TRUE]$UI, 
      ...
      column( 
        ...
        fluidPage(
          sidebarLayout(
            sidebarPanel(width = 6,
                         selectInput("sc1a2drX2", "X-axis:", choices = sc1conf[dimred == TRUE]$UI, 
                                     selected = sc1def$dimred[3]), 
        ...
        fluidPage(
          sidebarLayout(
            sidebarPanel(width = 6,
                         ...
                         selectInput("sc1a3drX2", "X-axis:", choices = sc1conf[dimred == TRUE]$UI, 
                                     selected = sc1def$dimred[3]), 
    ...
    fluidPage(
      sidebarLayout(
        ...
        selectInput("sc1d1grp", "Group by:",
                    choices = sc1conf[grp == TRUE]$UI[1:3],
    ...
    column(
      ...
      fluidPage(
        sidebarLayout(
          ...
          sidebarPanel(width = 6,
                       selectInput("sc2a3drX", "X-axis:", choices = sc2conf[dimred == TRUE]$UI,
  ...
  column(
      ...
      fluidPage(
        sidebarLayout(
          ...
          sidebarPanel(width = 6,
                       selectInput("sc2a3drX2", "X-axis:", choices = sc1conf[dimred == TRUE]$UI,
                                   selected = sc1def$dimred[5]),
    ...
    sidebarLayout(
      sidebarPanel(
        ...
        selectInput("sc2d1grp", "Group by:",
                    choices = sc2conf[grp == TRUE]$UI[1:3],
                    selected = sc2conf[grp == TRUE]$UI[2]) %>%
          helper(type = "inline", size = "m", fade = TRUE,
                 title = "Cell information to group cells by",
                 content = c("Select categorical cell information to group cells by",
                             "- Single cells are grouped by this categorical covariate",
